...
class RegisterController {
  static Future<CarResponse?> carUpload(String CarNm, String CarNo, File file, String token) async {
    try {

      final request = http.MultipartRequest('POST', Uri.parse('${BaseUrl}/api/car'));
